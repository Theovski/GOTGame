...
public class Turno {
    ...
    public Turno(Character personagem, Tabuleiro tabuleiro, Scanner teclado) {
...
private void realizarMovimento(){
    ...
    private void realizaAtaque(){
        ...
        Character alvo = tabuleiro.getPersonagem(posLinhaAlvo, posColunaAlvo);
...
System.out.println(alvo.getNome() + " sofreu " + String.format("%.1f", danoCausado) + " de dano.");
        ...
        if(!alvo.isVivo()){
            ...
            System.out.println(alvo.getNome() + " Ganhou! Vida: " + alvo.getVidaAtual());
        }
    }
}
